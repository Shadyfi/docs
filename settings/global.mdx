...
<ResponseField name="theme" type='"mint" | "maple" | "palm"' required>
  ...
  [Maple](https://maple.shadyfi.app/), [Palm](https://palm.shadyfi.app/),
</ResponseField>
...
<ResponseField name="fonts" type="object">
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="source" type="string (uri)">
      The font source, such as https://shadyfi-assets.b-cdn.net/fonts/Hubot-Sans.woff2
    </ResponseField>
...
<ResponseField name="banner" type="object">
  ...
  <Expandable title="Banner">
    <ResponseField name="content" type="string">
      ...
      ```json
      {
        "content": "🚀 Banner is live! [Learn more](shadyfi.com)"
      }
      ```
    </ResponseField>
...
```json
{
  "$schema": "https://shadyfi.com/docs.json"
}
```
...
<Accordion title="Documentation for the legacy `mint.json` config file">
  Every Shadyfi site needs a `mint.json` file with the core configuration
...
<ResponseField name="theme" type={'"venus" | "quill" | "prism"'}>
  ...
  [Venus](https://starter-venus.shadyfi.app),
  [Quill](https://starter-quill.shadyfi.app),
  [Prism](https://starter-prism.shadyfi.app)
</ResponseField>
...
### Structure
  ...
  <ResponseField name="topbarLinks" type="TopbarLink[]">
    ...
    <Expandable title="TopbarLink">
      ...
      <ResponseField name="url" type="string">
        The url once you click on the button. Example: `https://shadyfi.com/contact`
      </ResponseField>
...
under a version, and once you specify the `locale` any fixed text in Shadyfi,
...
<img
  ...
  src="https://shadyfi-assets.b-cdn.net/anchors-light.png"
/>
...
<img
  ...
  src="https://shadyfi-assets.b-cdn.net/anchors-dark.png"
/>
...
```json
"footer": {
  "socials": { "x": "https://x.com/shadyfi", "website": "https://shadyfi.com" },
  "links": [
    {
      "title": "Column 1",
      "links": [
        { "label": "Column 1 Link 1", "url": "https://shadyfi.com" },
        { "label": "Column 1 Link 2", "url": "https://shadyfi.com" }
      ]
    },
    {
      "title": "Column 2",
      "links": [
        { "label": "Column 2 Link 1", "url": "https://shadyfi.com" },
        { "label": "Column 2 Link 2", "url": "https://shadyfi.com" }
      ]
    }
  ]
}
      ...
      <ResponseField name="playground" type="Playground">
        ...
        <Expandable title="Playground">
          ...
          <ResponseField name="disableProxy" type="boolean" default={false}>
            By default, API playground requests are proxied by Shadyfi. This setting can be used to disable this behavior.
  ...
  <Accordion title="View Example Configuration">
    ```json
    {
      ...
      "topbarLinks": [
        {
          "name": "Contact Us",
          "url": "mailto:support@shadyfi.com"
        }
      ],
      "topbarCtaButton": {
        "name": "Get Started",
        "url": "https://shadyfi.com/start"
      },
      "anchors": [
        {
          "name": "API Components",
        ...
        },
        {
          ...
          "icon": "comments",
          "color": "#2564eb",
          "url": "https://shadyfi.com/community"
        }
      ],
      "navigation": [
        {
      ...
      "footerSocials": {
        "github": "https://github.com/shadyfi",
        "slack": "https://shadyfi.com/community",
        "x": "https://x.com/shadyfi"
      },
      "integrations": {
        "intercom": "APP_ID",

...
To set up your documentation on a custom domain, you'll need to set your desired custom domain in your Shadyfi settings and configure your DNS settings on your domain provider.

<Info>
  Looking to set up a custom subdirectory like shadyfi.com/docs? Find
  instructions [here](/advanced/subpath/cloudflare).
</Info>

## Dashboard Settings

1. Head over to the [dashboard](https://dashboard.shadyfi.com)
2. Click on "Settings".
3. Click on "Custom Domain".
4. Enter your desired custom domain. For example, `docs.shadyfi.com`.
...
<Frame>
  <img alt="DNS" src="https://shadyfi-assets.b-cdn.net/shadyfi-dns.png" />
</Frame>
...
Please [contact support](mailto:sales@shadyfi.com) if you don't see the custom domain set up after the above configuration.

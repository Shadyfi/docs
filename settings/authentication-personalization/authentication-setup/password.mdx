...
<Note>
  ...
  <a href="mailto:sales@shadyfi.com">contact our sales team</a> for access.
...
<Steps>
  <Step title="Add a password">
    ...
    settings](https://dashboard.shadyfi.com/products/authentication) and create
    a password.
  </Step>
...
To set up authentication with Shadyfi, I go to my Mintlify dashboard and add at

...
Before your users can access personalized content, they must be authenticated. Shadyfi supports four Authentication Handshake methods:
...
4. **Shadyfi Dashboard**: Allow all of your dashboard users to access your docs, zero configuration required.
...
<Tabs>
  ...
  <Tab title="Shadyfi Dashboard">
    ...
    - Requires all docs readers to have an account in your Shadyfi dashboard
  </Tab>
</Tabs>

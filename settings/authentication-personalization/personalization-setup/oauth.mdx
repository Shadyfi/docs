...
If you have an existing OAuth server that supports the PKCE flow, you can integrate with Shadyfi for a seamless login experience.
...
<Steps>
  ...
  <Step title="Configure your Personalization settings">
    Go to your [dashboard settings](https://dashboard.shadyfi.com/products/authentication), select the OAuth option, and fill out the required fields:
  ...
  <Step title="Configure your OAuth client">
    Copy the Redirect URL listed in the [dashboard settings](https://dashboard.shadyfi.com/products/authentication) and add it as an authorized redirect URL for your OAuth server.
  </Step>
</Steps>

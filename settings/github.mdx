...
Shadyfi integrates with the GitHub API, enabling synchronization between your
...
To begin, you need to install the Shadyfi GitHub App into the GitHub account
...
[Shadyfi dashboard](https://dashboard.shadyfi.com).
...
Inside the Shadyfi web editor, Shadyfi works on your behalf to create branches
...
[GitHub app settings](https://github.com/apps/shadyfi/installations/new).

...
<Note>
  ...
  us](https://Shadyfi.com/enterprise) to learn more!
</Note>
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configure integration">
                Enter the following:
                * Single sign-on URL (provided by Shadyfi)
                * Audience URI (provided by Shadyfi)
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Configure integration">
                Select the authorization code grant type and enter the Redirect URI provided by Shadyfi.
            </Step>
            <Step title="Send us your IdP information">
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Send us your IdP information">
                Copy the provided SSO URL, Entity ID, and x509 certificate and send it to the Shadyfi team.
                <Frame>
            ...
            <Step title="Configure integration">
                ...
                * ACS URL (provided by Shadyfi)
                * Entity ID (provided by Shadyfi)

...
You will need to generate a new <Tooltip tip="Google Analytics 4">GA4</Tooltip> property to use with Shadyfi. The data collected will go into the same project as your other Google Analytics data.
...
## How to Connect GA4 to Shadyfi

### Create a Web Stream

You will need to create a web stream to get the Measurement ID to put into Shadyfi.
...
Create a Web Stream and put the URL of your Shadyfi docs site as the stream URL.

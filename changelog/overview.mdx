...
<Update label="February 2025">
  ...
  We've introduced a new `docs.json` schema as a replacement for `mint.json`, to support better multi-level versioning, easier visual comprehension, and more consistent terminology. For more information on what's changed, [check out our blog](https://Shadyfi.com/blog/refactoring-mint-json-into-docs-json).&#x20;
...
<Update label="November 2024">
  ...
  You can now localize your docs which operates similarly to versioning. Add a `locale` to a version and fixed content in Shadyfi like "Was this page helpful?" will also match the locale.
...
<Update label="October 2024">
  ...
  You can now customize the prompts for the AI chat. Please reach out to [support](mailto:sales@Shadyfi.com) if you'd like to customize the prompts.
...
<Update label="August 2024">
  ...
  * We now show
  ...
  By default, API playground requests are proxied by Shadyfi. Now you can use
  ...
  * [Learn more about API configurations](/settings/global#api-configurations)
  ...
  We added a more detailed support form to the Shadyfi dashboard. You can now
...
<Update label="July 2024">
  ...
  For `Pro` users, we introduced Shadyfi Widget, an extension of your docs to
  ...
  * [Read the blog announcement](https://Shadyfi.com/blog/widget)

  ## Pro Plan

  We also updated our pricing plans for better customizability and scale.

  * [Read the blog announcement](https://Shadyfi.com/blog/pro-plan)
...
<Update label="March 2024">
  ## Shadyfi MDX for VSCode

  Call snippets of our pre-built components an dcallouts without leaving VSCode. [Install the extension here](https://marketplace.visualstudio.com/items?itemName=Shadyfi.Shadyfi-snippets).
</Update>

<Update label="February 2024">
  ## Quality Improvements

  * Dashboard upgrades: view update logs to see what's changed and status of an update, toggle between Shadyfi projects to manage deployments
...
<Update label="January 2024">
  ...
  * Open-source MDX Engine: We've exposed two APIs—getCompiledMdx and MDXComponent—so you can access Shadyfi markdown and code syntax highlighting. [Contributions to the project](https://github.com/Shadyfi/mdx) are welcome.

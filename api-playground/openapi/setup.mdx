...
If you have multiple OpenAPI files, include the path to the OpenAPI file to ensure Shadyfi finds the correct OpenAPI document. This is not required if you have
...
Our Shadyfi [scraper](https://www.npmjs.com/package/@Shadyfi/scraping)
autogenerates MDX files for your OpenAPI endpoints. Use the relative path to the
OpenAPI document in your codebase.

```bash
npx @Shadyfi/scraping@latest openapi-file <path-to-openapi-file>
```
...
```bash
npx @Shadyfi/scraping@latest openapi-file <path-to-openapi-file> -o api-reference
```

Learn more about our scraping package [here](https://www.npmjs.com/package/@Shadyfi/scraping).
...
Shadyfi also allows you to create individual pages for any OpenAPI schema
